...
// Listens for ANIMTUBE_CMD_GRAB (manual or future use)
...
async function grabLatestImage() {
    ...
    // Find all large images (not avatars/icons)
    ...
    // Take the LAST one (most recent in chat)
    const img = candidates[candidates.length - 1];

    // Simulate hover to reveal dynamic buttons
